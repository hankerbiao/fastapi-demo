...
router.include_router(comm.router, prefix='/comm', tags=["通用接口"])
router.include_router(h2.router, prefix='/h2', tags=["H2数据库管理"])
router.include_router(configuration.router, prefix='/configuration', tags=[" 配置管理"])
router.include_router(v3_management.router, prefix='/management', tags=["组件管理(v3)"])
